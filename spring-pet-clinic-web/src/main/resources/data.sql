...
insert into owners(first_name,last_name,address,city,telephone) values ('Hanshitha','Genesis','HIG-68,9th Phase, KPHB Colony','Hyderabad','9052899577');
insert into pets (name,type_id,owner_id,birth_date) values ('Johnny',1,1,current_date);