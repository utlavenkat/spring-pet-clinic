...
public class VisitServiceMapTest {
    ...
    public void setUp() {
        ...
        testVisit = new Visit(LocalDate.now(), "General Visit", null);
        testVisit.setId(1L);
    ...
    public void insert() {
        ...
        val visit = new Visit(LocalDate.now(), "Test Visit", pet);
    ...
    public void delete() {
        int initialSize = visitServiceMap.map.size();
        val visit = new Visit(LocalDate.now(), "General Visit", null);
        visit.setId(1L);
    ...
    public void testEmptyMapReturnsExpectedSequence() {
        visitServiceMap.map = new HashMap<>();
        val petType = new PetType("TestPetType");
        val pet = new Pet("TestPet",petType,new Owner("HIG-68,KPHB","Hyderabad","9100912536"), LocalDate.now());
        val visit = new Visit(LocalDate.now(), "General Visit", pet);
